...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			...
			" title='" + prevText + "'><span class='ui-icon ui-icon-circle-triangle-" + ( isRTL ? "e" : "w") + "'>" + '<i class="fa fa-chevron-left"></i>' + "</span></a>" :
		...
		next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			...
			" title='" + nextText + "'><span class='ui-icon ui-icon-circle-triangle-" + ( isRTL ? "w" : "e") + "'>" + '<i class="fa fa-chevron-right"></i>' + "</span></a>" :
