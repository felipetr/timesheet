...
if (isset($_SESSION['ts_RF']['language_file']) && file_exists($_SESSION['ts_RF']['language_file']))
{
	...
	require_once $_SESSION['ts_RF']['language_file'];
}
else
{
...
if (isset($_GET['action']))
{
	switch($_GET['action'])
	{
		...
		case 'paste_clipboard':
			if ( ! isset($_SESSION['ts_RF']['clipboard_action'], $_SESSION['ts_RF']['clipboard']['path'])
				|| $_SESSION['ts_RF']['clipboard_action'] == ''
				|| $_SESSION['ts_RF']['clipboard']['path'] == '')
			{
				response()->send();
				exit;
			}

			$action = $_SESSION['ts_RF']['clipboard_action'];
			$data = $_SESSION['ts_RF']['clipboard'];
			...
			// cleanup
			$_SESSION['ts_RF']['clipboard']['path'] = NULL;
