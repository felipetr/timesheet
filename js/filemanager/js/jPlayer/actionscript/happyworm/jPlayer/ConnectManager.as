...
package happyworm.jPlayer {
	...
	public class ConnectManager extends Object {
		...
		private var porarr:Array = new Array("",":1935",":80",":443");
		...
		var innerLoop:Number=0;
			for (outerLoop=0; outerLoop<protocols_arr.length; outerLoop++) {
				...
				for (innerLoop=0; innerLoop<porarr.length; innerLoop++) {
					m_connList.push( { protocol: protocols_arr[outerLoop], port: porarr[innerLoop] } );
				}
