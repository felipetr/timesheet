...
{
	// language
	if ( ! isset($_SESSION['ts_RF']['language'])
		|| file_exists($_SESSION['ts_RF']['language_file']) === false
		|| ! is_readable($_SESSION['ts_RF']['language_file'])
	)
	{
		...
		$_SESSION['ts_RF']['language_file'] = $language_file;
	}
	else
	{
		$lang = $_SESSION['ts_RF']['language'];
		$language_file = $_SESSION['ts_RF']['language_file'];
	}
