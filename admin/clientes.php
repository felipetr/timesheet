...
$botaotopo = '<a href="' . $baseurl . '/admin/cliente.php/novo"><i class="fa fa-plus"></i> Novo Cliente</a>';
$ativo = 'clientes';
        ...
        <table class="table table-striped">
            ...
            while ($pag = mysqli_fetch_array($queryint)) {
                ...
                <tr id="pagina-<?php echo $pag['id']; ?>">
                    <td class="nome"><a id="nome-<?php echo $pag['id']; ?>)" href="<?php echo $baseurl; ?>/admin/cliente.php/<?php echo $pag['slug']; ?>"><?php echo $pag['nome']; ?></a></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button data-id="" data-tabela="cliente" onclick="confirmadel();" id="confirmadel" style="float: left;" type="button" class="btn btn-default" data-dismiss="modal">Confirmar</button>
