...
<head>
    <meta charset="UTF-8">
    <title>Timesheet - Admin - Recuperação de Senha</title>
...
<body>
<form id="formlogin" onsubmit="reenviasenha(baseurl); return false;" class="loginform">
    <img src="imgs/gerens.svg">
	<br>	<br>
    <div id="erromsg"></div>
    <input id="email" type="text" name="email" class="form-control" placeholder="Email" required/>
	<br>
    <button  class="btn btn-block btn-info" style="cursor:pointer;">Recuperar Senha</button>
