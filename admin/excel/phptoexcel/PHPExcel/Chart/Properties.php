...
abstract class PHPExcel_Chart_Properties
{
    ...
    const
        SHADOW_PRESENOSHADOW = null,
        SHADOW_PRESEOUTER_BOTTTOM_RIGHT = 1,
        SHADOW_PRESEOUTER_BOTTOM = 2,
        SHADOW_PRESEOUTER_BOTTOM_LEFT = 3,
        SHADOW_PRESEOUTER_RIGHT = 4,
        SHADOW_PRESEOUTER_CENTER = 5,
        SHADOW_PRESEOUTER_LEFT = 6,
        SHADOW_PRESEOUTER_TOP_RIGHT = 7,
        SHADOW_PRESEOUTER_TOP = 8,
        SHADOW_PRESEOUTER_TOP_LEFT = 9,
        SHADOW_PRESEINNER_BOTTTOM_RIGHT = 10,
        SHADOW_PRESEINNER_BOTTOM = 11,
        SHADOW_PRESEINNER_BOTTOM_LEFT = 12,
        SHADOW_PRESEINNER_RIGHT = 13,
        SHADOW_PRESEINNER_CENTER = 14,
        SHADOW_PRESEINNER_LEFT = 15,
        SHADOW_PRESEINNER_TOP_RIGHT = 16,
        SHADOW_PRESEINNER_TOP = 17,
        SHADOW_PRESEINNER_TOP_LEFT = 18,
        SHADOW_PRESEPERSPECTIVE_BELOW = 19,
        SHADOW_PRESEPERSPECTIVE_UPPER_RIGHT = 20,
        SHADOW_PRESEPERSPECTIVE_UPPER_LEFT = 21,
        SHADOW_PRESEPERSPECTIVE_LOWER_RIGHT = 22,
        SHADOW_PRESEPERSPECTIVE_LOWER_LEFT = 23;
    ...
    protected function getShadowPresetsMap($shadow_preseoption)
    {
        $preseoptions = array(
            //OUTER
            1 => array(
        ...
        return $preseoptions[$shadow_preseoption];
    }
